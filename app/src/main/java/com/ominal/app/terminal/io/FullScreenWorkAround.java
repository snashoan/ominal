...
/**
 * Work around for fullscreen mode in Ominal to fix ExtraKeysView not being visible.
...
public class FullScreenWorkAround {
    ...
    public static void apply(OminalActivity activity) {
        new FullScreenWorkAround(activity);
    }

    private FullScreenWorkAround(OminalActivity activity) {
