...
public class OminalOpenReceiver extends BroadcastReceiver {

    private static final String LOG_TAG = "OminalOpenReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Uri uriToShare = UriUtils.getContentUri(OminalConstants.OMINAL_FILE_SHARE_URI_AUTHORITY, fileToShare.getAbsolutePath());
    ...
    public static class ContentProvider extends android.content.ContentProvider {
        ...
        private static final String LOG_TAG = "OminalContentProvider";
        ...
        public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String mode) throws FileNotFoundException {
            ...
            try {
                ...
                if (!(path.startsWith(OminalConstants.OMINAL_FILES_DIR_PATH) || path.startsWith(storagePath))) {
                    throw new IllegalArgumentException("Invalid path: " + path);
                }

                // If OminalConstants.PROP_ALLOW_EXTERNAL_APPS property to not set to "true", then throw exception
                String errmsg = OminalPluginUtils.checkIfAllowExternalAppsPolicyIsViolated(getContext(), LOG_TAG);
                if (errmsg != null) {
                ...
                // OminalConstants.PROP_ALLOW_EXTERNAL_APPS set by users without their explicit consent.
                if (OminalConstants.OMINAL_PROPERTIES_FILE_PATHS_LIST.contains(path) ||
                    OminalConstants.OMINAL_FLOAT_PROPERTIES_FILE_PATHS_LIST.contains(path)) {
                    mode = "r";
                }
