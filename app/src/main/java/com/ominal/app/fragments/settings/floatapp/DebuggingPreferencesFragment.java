package com.ominal.app.fragments.settings.runtime_float;
...
public class DebuggingPreferencesFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        setPreferencesFromResource(R.xml.ominal_float_debugging_preferences, rootKey);
    ...
    private void configureLoggingPreferences(@NonNull Context context) {
        ...
        if (logLevelListPreference != null) {
            OminalFloatAppSharedPreferences preferences = OminalFloatAppSharedPreferences.build(context, true);
            if (preferences == null) return;

            com.ominal.app.fragments.settings.runtime.DebuggingPreferencesFragment.
