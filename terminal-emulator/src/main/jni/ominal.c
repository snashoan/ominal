...
#define OMINAL_UNUSED(x) x __attribute__((__unused__))
#ifdef __APPLE__
...
JNIEXPORT jint JNICALL Java_com_ominal_terminal_JNI_createSubprocess(
        JNIEnv* env,
        jclass OMINAL_UNUSED(clazz),
        jstring cmd,
        jstring cwd,
        jobjectArray args,
...
JNIEXPORT void JNICALL Java_com_ominal_terminal_JNI_setPtyWindowSize(JNIEnv* OMINAL_UNUSED(env), jclass OMINAL_UNUSED(clazz), jint fd, jint rows, jint cols, jint cell_width, jint cell_height)
{
...
JNIEXPORT void JNICALL Java_com_ominal_terminal_JNI_setPtyUTF8Mode(JNIEnv* OMINAL_UNUSED(env), jclass OMINAL_UNUSED(clazz), jint fd)
{
    struct termios tios;
    tcgetattr(fd, &tios);
...
JNIEXPORT jint JNICALL Java_com_ominal_terminal_JNI_waitFor(JNIEnv* OMINAL_UNUSED(env), jclass OMINAL_UNUSED(clazz), jint pid)
{
    int status;
...
JNIEXPORT void JNICALL Java_com_ominal_terminal_JNI_close(JNIEnv* OMINAL_UNUSED(env), jclass OMINAL_UNUSED(clazz), jint fileDescriptor)
{
