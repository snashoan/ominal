 ...
 *
 * - 0.2.0 (2021-03-11)
 *      - Renamed `HOME_PATH` to `OMINAL_HOME_DIR_PATH`.
 *      - Renamed `OMINAL_PROPERTIES_PRIMARY_PATH` to `OMINAL_PROPERTIES_PRIMARY_FILE_PATH`.
 *      - Renamed `OMINAL_PROPERTIES_SECONDARY_FILE_PATH` to `OMINAL_PROPERTIES_SECONDARY_FILE_PATH`.
 *
 * - 0.3.0 (2021-03-16)
 ...
 *
 * - 0.14.0 (2021-09-02)
 *      - Add `getOminalFloatPropertiesFile()`.
 *
 * - 0.15.0 (2021-09-05)
...
/**
 * A class that defines shared constants of the SharedProperties used by Ominal app and its plugins.
 ...
 * {@link OminalConstants#OMINAL_PROPERTIES_PRIMARY_FILE_PATH} or
 * {@link OminalConstants#OMINAL_PROPERTIES_SECONDARY_FILE_PATH}
 */
public final class OminalPropertyConstants {

    private static final String LOG_TAG = "OminalPropertyConstants";
    ...
    /** Defines the key for whether to hide soft keyboard when ominal app is started */
     ...
     * deleted from $TMPDIR on ominal exit.
    ...
    public static final String DEFAULT_IVALUE_DEFAULT_WORKING_DIRECTORY = OminalConstants.OMINAL_HOME_DIR_PATH;
    ...
    /** Defines the set for keys loaded by ominal
     * Setting this to {@code null} will make {@link SharedProperties} throw an exception.
     * */
    public static final Set<String> OMINAL_APP_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
        /* boolean */
        ...
        OminalConstants.PROP_ALLOW_EXTERNAL_APPS,
    ...
    /** Defines the set for keys loaded by ominal that have default boolean behaviour with false as default.
     * "true" -> true
     * "false" -> false
     * default: false
     */
    public static final Set<String> OMINAL_DEFAULT_FALSE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
        KEY_DISABLE_FILE_SHARE_RECEIVER,
        KEY_DISABLE_FILE_VIEW_RECEIVER,
        KEY_DISABLE_HARDWARE_KEYBOARD_SHORTCUTS,
        KEY_DISABLE_TERMINAL_SESSION_CHANGE_TOAST,
    ...
    /** Defines the set for keys loaded by ominal that have default boolean behaviour with true as default.
     * "true" -> true
     * "false" -> false
     * default: true
     */
    public static final Set<String> OMINAL_DEFAULT_TRUE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
        KEY_EXTRA_KEYS_TEXT_ALL_CAPS
    ));

    /** Defines the set for keys loaded by ominal that have default inverted boolean behaviour with false as default.
     * "false" -> true
     * "true" -> false
     * default: false
     */
    public static final Set<String> OMINAL_DEFAULT_INVERETED_FALSE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
    ));

    /** Defines the set for keys loaded by ominal that have default inverted boolean behaviour with true as default.
     * "false" -> true
     * "true" -> false
     * default: true
     */
    public static final Set<String> OMINAL_DEFAULT_INVERETED_TRUE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
    ));
