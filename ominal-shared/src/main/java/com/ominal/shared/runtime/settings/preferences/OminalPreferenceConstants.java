 ...
 *          Ominal app and its plugins. This will allow {@link com.ominal.app.OminalSettings} to
 ...
 *      - Added following to `OMINAL_TASKER_APP`:
 *           `KEY_LOG_LEVEL`.
 *
 * - 0.4.0 (2021-03-13)
 *      - Added following to `OMINAL_APP`:
 ...
 *
 * - 0.6.0 (2021-03-24)
 *      - Change `DEFAULT_VALUE_KEEP_SCREEN_ON` value to `false` in `OMINAL_APP`.
 *
 * - 0.7.0 (2021-03-27)
 *      - Added following to `OMINAL_APP`:
 ...
 *
 * - 0.12.0 (2021-08-27)
 *      - Added `OMINAL_API_APP.KEY_LOG_LEVEL`, `OMINAL_BOOT_APP.KEY_LOG_LEVEL`,
 *          `OMINAL_FLOAT_APP.KEY_LOG_LEVEL`, `OMINAL_STYLING_APP.KEY_LOG_LEVEL`,
 *          `OMINAL_Widget_APP.KEY_LOG_LEVEL`.
 *
 * - 0.13.0 (2021-09-02)
 *      - Added following to `OMINAL_FLOAT_APP`:
 *          `KEY_WINDOW_X`, `KEY_WINDOW_Y`, `KEY_WINDOW_WIDTH`, `KEY_WINDOW_HEIGHT`, `KEY_FONTSIZE`,
 *          `KEY_TERMINAL_VIEW_KEY_LOGGING_ENABLED`.
 *
 * - 0.14.0 (2021-09-04)
 *      - Added `OMINAL_WIDGET_APP.KEY_TOKEN`.
 *
 * - 0.15.0 (2021-09-05)
 *      - Added following to `OMINAL_TASKER_APP`:
...
/**
 * A class that defines shared constants of the SharedPreferences used by Ominal app and its plugins.
 ...
 */
public final class OminalPreferenceConstants {
    ...
    public static final class OMINAL_APP {
        ...
        /**
         * Defines the key for font size of ominal terminal view.
         */
        public static final String KEY_FONTSIZE = "fontsize";


        /**
         * Defines the key for current ominal terminal session.
         */
        ...
        /**
         * The {@link ExecutionCommand.Runner#APP_SHELL} number after ominal app process since boot.
         */
        ...
        /**
         * The {@link ExecutionCommand.Runner#TERMINAL_SESSION} number after ominal app process since boot.
         */
        ...
        /**
         * Defines the key for whether ominal terminal view key logging is enabled or not
         */
