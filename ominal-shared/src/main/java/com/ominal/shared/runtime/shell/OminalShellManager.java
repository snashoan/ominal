...
public class OminalShellManager {

    private static OminalShellManager shellManager;
    ...
    /**
     * The foreground OminalSessions which this service manages.
     * Note that this list is observed by an activity, like OminalActivity.mOminalSessionListViewController,
     * so any changes must be made on the UI thread and followed by a call to
     * {@link ArrayAdapter#notifyDataSetChanged()}.
     */
    public final List<OminalSession> mOminalSessions = new ArrayList<>();

    /**
     * The background OminalTasks which this service manages.
     */
    public final List<AppShell> mOminalTasks = new ArrayList<>();
    ...
    public OminalShellManager(@NonNull Context context) {
     ...
     * @return Returns the {@link OminalShellManager}.
     */
    public static OminalShellManager init(@NonNull Context context) {
        if (shellManager == null)
            shellManager = new OminalShellManager(context);
     ...
     * @return Returns the {@link OminalShellManager}.
     */
    public static OminalShellManager getShellManager() {
        return shellManager;
    }
