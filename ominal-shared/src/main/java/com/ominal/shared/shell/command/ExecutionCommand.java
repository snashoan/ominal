package com.ominal.shared.shell.command;
...
public class ExecutionCommand {
    ...
    Only the {@link #errCode} being non-zero means that execution command failed from the Ominal app
    perspective.
    */
     ...
     * commands. By default, @link com.ominal.shared.shell.StreamGobbler} only logs stdout and
    ...
    /** Defines the markdown text for the help of the Ominal plugin API that was used to start the
     ...
     * like with an intent or from within Ominal app itself. */
