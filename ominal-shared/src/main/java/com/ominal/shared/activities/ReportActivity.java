 ...
 * {@code `<activity android:name="com.ominal.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.OminalReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.ominal.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
    ...
    private void updateUI() {
        ...
        if (actionBar != null) {
            if (mReportInfo.reportTitle != null)
                ...
                actionBar.setTitle(OminalConstants.OMINAL_APP_NAME + " App Report");
        }
